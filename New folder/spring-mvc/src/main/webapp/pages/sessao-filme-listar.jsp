    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
				...
				<p class="toolbar">
					<a class="create btn btn-default" href="produtos-nova.html">Novo Produto</a>
				...
				<table class="table table-striped" cellspacing="0" cellpadding="0">
					...
					<tbody>
						<tr>
							<td>Produto Versão #1 - 2014</td>
							<td>R$ 100,02</td>
							<td class="actions">
								<a class="btn btn-success btn-xs" href="produtos-detalhe.html">Detalhes</a>
